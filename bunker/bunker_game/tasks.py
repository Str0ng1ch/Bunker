tasks = {
    "planimetria": [
        ['Площадь треугольника ABC равна 176, DE — средняя линия. Найдите площадь треугольника CDE', 44, 'test.svg', r'''
    ...
    'stereometry': [
        ...
        ['Площадь полной поверхности конуса равна 164. Параллельно основанию конуса проведено сечение, делящее высоту в отношении 1:1, считая от вершины конуса. Найдите площадь полной поверхности отсечённого конуса.', '41', '3_5.svg', 'Исходный и отсеченный конус подобны с коэффициентом подобия 2. Площади поверхностей подобных тел относятся как квадрат коэффициента подобия. Поэтому площадь отсеченного конуса в 4 раза меньше площади поверхности исходного. Тем самым, она равна 41.']
    ],
    'probability_beginnings': [
        ['В случайном эксперименте бросают две игральные кости. Найдите вероятность того, что в сумме выпадет 10 очков. Результат округлите до сотых.', '0.08', '', 'Количество исходов, при которых в результате броска игральных костей выпадет 10 очков, равно 3: 4+6, 5+5, 6+4. Каждый из кубиков может выпасть шестью вариантами, поэтому общее число исходов равно 6·6=36. Следовательно, вероятность того, что в сумме выпадет 10 очков, равна 3/36 = 0.083'],
        ...
        ['В случайном эксперименте симметричную монету бросают трижды. Найдите вероятность того, что наступит исход ООР (в первый и второй разы выпадает орёл, в третий — решка).', '0.125', '', 'Всего возможных исходов  — восемь: ООО, ООР, ОРО, ОРР, РРР, РРО, РОО, РОР. Благоприятным является один: орел-орел-решка. Следовательно, искомая вероятность равна 1 : 8 = 0,125.']
    ],
    'complex_events_probability': [
        ['В ящике семь красных и три синих фломастера. Фломастеры вытаскивают по очереди в случайном порядке. Какова вероятность того, что первый раз синий фломастер появится третьим по счету?', '0.175', '', 'Изобразим с помощью дерева возможные исходы. Последовательность исходов, приводящая к событию «первый раз синий фломастер появится третьим по счету» выделена оранжевым цветом. Искомая вероятность равна 7/10 · 6/9 · 3/8 - 7/40 = 0.175']
    ],
    'simple_equations': [
        ['Найдите корень уравнения', '2', '6_1.svg', r'Используем формулу \(\scriptsize\log_x d^n = \frac{n}{n}\)  \(\scriptsize\log_8 2^{8x-4} = 4 \Leftrightarrow \log_{7^3} 2^{kx-4} = 4 \Leftrightarrow \frac{8x-4}{3} = 4 \Leftrightarrow 8x-4 = 12 \Leftrightarrow x=2\)'],
        ['Найдите корень уравнения', '321', '6_2.svg', r'Возведем в квадрат: \(\scriptsize\sqrt{\frac{6}{2x-42}} = \frac{1}{10} \Leftrightarrow \frac{6}{2x-42} = \frac{1}{100} \Leftrightarrow 600 = 2x-42 \Leftrightarrow x = 321\)']
    ],
    'calculations_transformations': [
        ['Найдите значение выражения', 1, '7_1.svg', r'\(\scriptsize\frac{\sqrt[4]{3} \cdot \sqrt[16]{3}}{\sqrt[16]{3}} = \frac{3+5 \cdot 3 \frac{1}{6}}{3^{\frac{1}{12}}} = 3^{\frac{1}{48}} + \frac{1}{16} - \frac{1}{12} = 3^0 = 1\)']
    ],
    'derivative_integral': [
        ['На рисунке изображён график функции y=f(x), определённой на интервале (-3; 10) Найдите количество точек, в которых производная функции f(x) равна 0.', 10, '8_1.svg', 'Производная изображенной на рисунке функции f(x) равна нулю в точках экстремумов: −2; −1; 0; 1; 2; 3; 6; 7; 8 и 9,6. Производная равна нулю в 10 точках.'],
